export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'omgmaster',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Omgmaster',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'omgmaster.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://omgmaster.com',
